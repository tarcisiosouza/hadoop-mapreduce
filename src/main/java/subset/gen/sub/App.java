...
public class App {
	...
	public static class SampleMapper extends
		...
		protected void setup(Context context) throws IOException,
			...
			FileSystem fileSystem2 = location2.getFileSystem(context
					.getConfiguration());

			RemoteIterator<LocatedFileStatus> fileStatusListIterator2 = fileSystem2
					.listFiles(new Path("/user/souza/complement.txt"), true);
			...
			while (fileStatusListIterator2.hasNext()) {
				...
				BufferedReader br = new BufferedReader(new InputStreamReader(
						fileSystem2.open(fileStatus.getPath())));
		...
		public void map(Object key, Text value, Context context)
			...
			if (filename.contains("_SUCESS") || filename.contains("_index")
					|| filename.contains("_masterindex"))
				return;
